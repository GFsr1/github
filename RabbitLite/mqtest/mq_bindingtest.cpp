...
zkpmq::BindingManager::ptr bmp;

class QueueTest : public testing::Environment {
    public:
        virtual void SetUp() override {
            bmp = std::make_shared<zkpmq::BindingManager>("./data/meta.db");
        }
...
TEST(queue_test, select_test) {
    ...
    zkpmq::Binding::ptr bp = bmp->getBinding("exchange1", "queue1");
...
//     zkpmq::MsgQueueBindMap mqbm = bmp->getExchangeBindings("exchange1");
