...
int main() {
    ...
    helper.exec(ct, nullptr, nullptr);
    // 3. 新增数据，修改，删除，查询
    // const char *insert_sql = "insert into student values(1, '小张', 18), (2, '小吴', 19), (3, '小明', 18);";
    ...
    // const char *update_sql = "delete from student where sn=3;";
    // assert(helper.exec(update_sql, nullptr, nullptr));
